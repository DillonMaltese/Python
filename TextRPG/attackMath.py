...
def attack(doubleAttackPerc, mainWeaponDamage, eHP, Class, specialAttackPerc, specialAttack):
    print('first in file', mainWeaponDamage)
    ...
    if doubleAttackAns <= doubleAttackPerc:
        ...
        if specialAttackAns <= specialAttackPerc-10:
            ...
            print('second in file', mainWeaponDamage)
            print('You hit the enemy for', mainWeaponDamage, 'damage')
            print('third in file', mainWeaponDamage)
            eHP = eHP - mainWeaponDamage

    return eHP, mainWeaponDamage